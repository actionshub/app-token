...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getInstallationToken = exports.getInstallationId = exports.newGitHubApp = void 0;
...
async function getInstallationId(app, owner) {
    ...
    throw new Error('No installation found for this app, is it installed on this org/user?');
}
exports.getInstallationId = getInstallationId;
async function getInstallationToken(appId, privateKey, clientId, clientSecret, installationId) {
...
const getEnvironmentVariable = (name, options = {}) => {
